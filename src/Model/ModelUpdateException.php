...
/**
 * (422 Unprocessable Entity): Indicates that a model could not be updated.
 */
class ModelUpdateException extends UnprocessableEntityException
{
    ...
    public function __construct(Model $model, ?string $reason = null)
    {
        ...
        $message = $reason === null
            ? __('api-exceptions::messages.model_update_failed', [
                'model' => $this->model,
                'key' => $this->keyName,
                'value' => $this->keyValue,
            ])
            : __('api-exceptions::messages.model_update_failed_with_reason', [
                'model' => $this->model,
                'key' => $this->keyName,
                'value' => $this->keyValue,
                'reason' => $reason,
